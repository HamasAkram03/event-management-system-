...
<head>
    ...
    <title>Student Dashboard - Universe Events</title>
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .stats-grid, .actions-grid, .events-grid {
...
<body>
    ...
    <section class="dashboard-actions">
        <div class="section-title">
            ...
            <p>Manage your event participation and profile</p>
        </div>
        ...
        <div class="actions-grid">
            <div class="action-card">
                ...
                <p>Discover upcoming university events, workshops, and activities. Filter by category, date, or popularity.</p>
            ...
            <div class="action-card">
                ...
                <p>View and manage your event registrations. See upcoming events you've signed up for and your attendance history.</p>
                <a href="my_registrations.php" class="action-btn">
                    <i class="fas fa-arrow-right"></i>
                    My Registrations
                </a>
            </div>
            ...
            <div class="action-card">
                ...
                <p>Update your personal information, change your password, and manage your notification preferences.</p>
    ...
    <section class="upcoming-events">
        <div class="section-title">
            ...
            <p>Events you're registered for in the next 30 days</p>
        </div>
        ...
        <div class="events-grid">
            <div class="event-card">
                ...
                <div class="event-content">
                    ...
                    <p class="event-description">Hands-on workshop covering HTML, CSS, and JavaScript fundamentals.</p>
                    <div class="event-meta">
                        <span><i class="fas fa-map-marker-alt"></i> Tech Building 101</span>
            ...
            <div class="event-card">
                ...
                <div class="event-content">
                    <div class="event-date">
                        <i class="far fa-calendar-alt"></i>
                        <span>Oct 28, 10:00 AM</span>
                    </div>
                    <h3 class="event-title">Tech Career Fair 2023</h3>
                    <p class="event-description">Connect with top tech companies and explore internship opportunities.</p>
                    <div class="event-meta">
            ...
            <div class="event-card">
                ...
                <div class="event-content">
                    <div class="event-date">
                        <i class="far fa-calendar-alt"></i>
                        <span>Nov 5, 6:00 PM</span>
                    </div>
                    <h3 class="event-title">International Food Festival</h3>
                    <p class="event-description">Experience diverse cuisines from around the world with student performances.</p>
                    <div class="event-meta">
                        <span><i class="fas fa-map-marker-alt"></i> University Quad</span>
